    ...
    return (
        ...
        <div className="absolute left-[762px] top-[58px] flex-col justify-start items-start gap-1 inline-flex">
          <div className="flex-col justify-start items-start gap-1">
            <Label className="text-gray-200 text-lg font-semibold font-['SF Pro Display'] leading-none">Registration Number</Label>
            <Input className="self-stretch p-3 my-2 text-gray-200 bg-zinc-700 rounded border border-gray-700" maxLength={17}
        ...
        <RadioGroup className="absolute left-[383px] top-[162px]" onValueChange={(value) => setProgramme(value)}>
          ...
          <div className="flex items-center gap-20 my-4">
            <div className="flex items-center my-2 gap-1">
              <RadioGroupItem value={"UG"} className="w-5 h-5 bg-zinc-300 rounded-full" />
              <Label className="text-gray-100 text-base font-normal font-['SF Pro Display']">UG</Label>
            </div>
            <div className="flex items-center gap-1">
              <RadioGroupItem value={"PG"} className="w-5 h-5 bg-zinc-300 rounded-full" />
              <Label className="text-gray-100 text-base font-normal font-['SF Pro Display']">PG</Label>
            </div>
          </div>
        </RadioGroup>
        <RadioGroup onValueChange={(value) => setTypeOfLeave(value)}>
        <Label className="absolute left-[382px] top-[267px] text-gray-200 text-lg font-semibold font-['SF Pro Display'] leading-none">Type of leave</Label>
        <Label className="absolute left-[411px] top-[311px] text-gray-100 text-base font-normal font-['SF Pro Display']">OD (Permissive)</Label>
        <RadioGroupItem value={"OD (Permissive)"} className="w-5 h-5 absolute left-[23.75em] top-[19.625em] bg-zinc-300 rounded-full" />
        <Label className="absolute left-[570px] top-[311px] text-gray-100 text-base font-normal font-['SF Pro Display']">OD (Personal)</Label>
        <RadioGroupItem value={"OD (Personal)"} className="w-5 h-5 absolute left-[34em] top-[19.625em] bg-zinc-300 rounded-full" />
        <Label className="absolute left-[714px] top-[311px] text-gray-100 text-base font-normal font-['SF Pro Display']">ML</Label>
        <RadioGroupItem value={"ML"} className="w-5 h-5 absolute left-[43em] top-[19.625em] bg-zinc-300 rounded-full" />
        </RadioGroup>
        <div className="absolute my-2 left-[381px] top-[396px]">
          <input className="w-[210px] h-[50px] text-center px-1em bg-inherit text-stone-300 text-base font-normal font-['Inter'] absolute justify-center items-center inline-flex rounded-lg border border-stone-300"
