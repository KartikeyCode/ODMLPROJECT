...
export default function ApplicationForm() {
    ...
    const handleSubmit = (e) => {
      e.preventDefault();
      if (name && registrationNumber && programme && semester && department &&
      ...
      <main className="min-w-screen min-h-screen flex-col justify-start items-start overflow-auto inline-flex relative bg-stone-900">
        ...
        <Form onSubmit={handleSubmit}>
          <div className="absolute left-[383px] top-[58px] flex-col justify-start items-start gap-6 inline-flex">
            <div className="self-stretch flex-col justify-start items-start gap-1">
              ...
              <Input
                ...
                type="text" placeholder="Vedant Utage"
          ...
          <div className="absolute left-[762px] top-[58px] flex-col justify-start items-start gap-1 inline-flex">
            <div className="flex-col justify-start items-start gap-1">
              ...
              <Input
                ...
                maxLength={17} type="text" value={registrationNumber} placeholder="RA2111033010031"
          ...
          [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
              type="number" value={semester} placeholder="6"
              min={1} max={10} onChange={(e) => setSemester(e.target.value)} />
          </div>
          <RadioGroup
          ...
          >
            ...
            <div className="flex items-center gap-20 my-4">
              <div className="flex items-center my-2 gap-1">
                <RadioGroupItem
                  value={"UG"} className="w-5 h-5 bg-zinc-300 rounded-full"/>
              ...
              <div className="flex items-center gap-1">
                <RadioGroupItem
                  value={"PG"} className="w-5 h-5 bg-zinc-300 rounded-full"  />
                <Label className="text-gray-100 text-base font-normal font-['SF Pro Display']">
                  PG
                </Label>
              </div>
          ...
          <ToastContainer position="top-center" autoClose={2500} hideProgressBar={false}
            newestOnTop={false} closeOnClick rtl={false} pauseOnFocusLoss  pauseOnHover theme="dark"/>
          <div>
            <input
              className="hidden" type="file"
              ref={proofInputRef} onChange={handleProofUpload}/>
            <Button
