...
export default function Navbar(){
    ...
    return(
        ...
        <div className="absolute py-2 md:py-0 px-4 min-w-full justify-between flex flex-col  md:flex-row items-center md:sticky  max-h-32 lg:h-20 bg-[#FAE969] ">
            ...
            <h1 className=" lg:text-4xl text-2xl font-Lato font-bold text-white "> ODML Project </h1>
            </div>
            <div className="flex">
        ...
        >
          <div className=" flex justify-center md:flex-row">
            <Link
              href="/"
              className="hover:scale-110 text-white text-xl font-bold font-Cinz mr-6 xl:text-2xl"
            >
              {" "}
              Home{" "}
            </Link>
